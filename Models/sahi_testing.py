...
def run(weights="trained200.pt", source="euro_pallet_brick_upright.mp4", view_img=False, save_img=False, exist_ok=False):
    """
...
def parse_opt():
    ...
    parser.add_argument("--weights", type=str, default="models/trained200.pt", help="initial weights path")
